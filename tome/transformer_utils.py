...
def multi_head_attention_forward(
    ...
    """
    key_padding_mask=None  # tokenn merging
    ...
    if need_weights:
        ...
        return attn_output,none,q, k,v


class MultiheadAttention1(nn.MultiheadAttention):
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Optional[Tensor] = None,
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_weights,q,k,v = multi_head_attention_forward(
        ...
        if self.batch_first:
            ...
            return attn_output, attn_output_weights,q,k,v
